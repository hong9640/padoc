...
Page {
    ...
    RowLayout {
        ...
        SideBar {
            ...
            titleText: "음성 트레이닝\n서비스"
            // 현재 페이지의 인덱스 전달
            currentIndex: advancedTraining12Page.pageIndex
        ...
        Rectangle {
            ...
            MicButton {
                ...
                onClicked: {
                    ...
                    if(mainWindow.advancedcount1 === 3){
                        mainStackView.push(
                                    "qrc:/qml/screens/training/AdvancedTraining21.qml")
                    }
                    else{
                        mainWindow.advancedcount1++;
                        mainStackView.pop();
                    }
                }
            }
