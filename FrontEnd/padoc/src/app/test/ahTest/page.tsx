...
import styles from './ahTest.module.css';
  ...
  return (
    <main className={styles.page}>
      ...
      <header className={styles.headerBar}>
        <h1 className={styles.title}>1번 음성 테스트</h1>
        <p className={styles.subtitle}>
          녹음 버튼을 누른 뒤, 가능한 한 길게 안정적으로 "아—"를 발성해주세요.
        </p>
      </header>

      <section className={styles.grid}>
        {/* ✅ sentenceTest와 동일한 '녹음하기' 카드 레이아웃 */}
        <section
        ...
        >
          <h2 id="record-title" className={styles.sectionTitle}>녹음하기</h2>
            ...
            <div className={styles.waveClamp}>
              <TestRecord recording_type="voice_ah" />
            </div>
        </section>
          ...
          <div className={styles.sideCard}>
            ...
            <p className={styles.sideHelp}>녹음이 어렵다면, 저장된 음성 파일을 업로드하세요.</p>
              <FileUpload apiUrl={beApiUrl} recording_type="voice_ah" />
